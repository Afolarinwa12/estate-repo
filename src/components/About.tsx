    ...
    >
      ...
      <div className='flex flex-col md:flex-row items-center md:items-start md:gap-20'>
        ...
        <div className='flex flex-col items-center md:items-start mt-10 text-gray-600'>
          ...
          We believe finding the perfect property is more than just a transaction—it’s
           a journey toward building the life you envision. Whether you're buying your first home, 
           investing in property, or looking for the ideal
           space to start a new chapter, we're here to make the process seamless, transparent, and rewarding.
            {showMore && (
              <span className='block mt-4'>
                With a deep understanding of the real estate market and a passion for helping people,
                 we offer expert guidance and personalized service every step of the way. Our listings include a wide range of residential,
                  commercial, and luxury properties, carefully curated to match diverse needs and lifestyles.
